...
class MovieLanguages(models.Model):
    ...
    movie = models.ForeignKey(Movie, on_delete=models.CASCADE, related_name='languages_movie')
...
class Rating(models.Model):
    ...
    star = models.PositiveSmallIntegerField(choices=[(i, str(i))for i in range(1,11)], null=True, blank=True)
...
class ReviewLike(models.Model):
    ...
    def __str__(self):
        return f'{self.user.username} {self.review.like}'
...
class FavoriteMovie(models.Model):
    ...
    def __str__(self):
        return f'{self.favorite.movie.movie_name}'
