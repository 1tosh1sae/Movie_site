...
MovieLanguages, Moments, Rating, ReviewLike, Review, FavoriteMovie, Favorite, History)
...
class CategoryDetailSerializer(serializers.ModelSerializer):
    genre_category = GenreSerializer(many=True, read_only=True)
    class Meta:
        model = Category
...
class ActorDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Actor
        fields = ['actor_name','bio','actor_image', 'age', 'actor_movie']
...
class MovieDetailSerializer(serializers.ModelSerializer):
    ...
    languages_movie = MovieLanguagesSerializer(read_only=True,many=True)
    ...
    class Meta:
        model = Movie
        fields = ['movie_image', 'movie_trailer', 'movie_name', 'slogan', 'status_movie',
                  'year', 'country', 'director', 'genre', 'types', 'movie_time', 'actor',
                  'description','languages_movie', 'avg_rating', 'count_people', 'movie_review', 'moment_review']
